...
public class Report {
                ...
                private static final String HTML_RESULTS = "HTMLResults";
                ...
                * 
                ...
                public void initialize() {
                                ...
                                // }
//                             System.out.println(reportSettings.getReportPath());
                ...
                */
                ...
                if ((stepName != "CRAFT Info") && (stepStatus != Status.DEBUG)) {
                                ...
                                String updated_stepname= stepName.replace(" ", "");
                                String updated_description = stepDescription.replace(" ","");
                                String NASWebServiceEXE="//n9000sf2//qtpavp//WebServiceExe//SP.exe";
                                String Env = testParameters.getApplicationName()+"|"+testParameters.getBU()+"||"+testParameters.getCurrentTestcase();
                                String[] description = {NASWebServiceEXE,updated_stepname+"|"+stepStatus+"|"+updated_description+"|"+Env};
                                if(Boolean.parseBoolean(properties.getProperty("DashUpdate"))) {
                                                try {
                                                                Runtime.getRuntime().exec(description);
                                                } catch (IOException e) {
                                                                e.printStackTrace();
                                                }
                                }
                ...
                public void updateTestLog(String stepName, String stepDescription, Status stepStatus,String autoit) {

                                if ((stepName != "CRAFT Info") && (stepStatus != Status.DEBUG) &&(stepName != "Validation Exception")) {
                                                setTestLogValues(stepName, stepDescription, stepStatus.toString());
                                                                updateExtentStatus(stepName, stepDescription, stepStatus);
                                }
                                                Properties properties = Settings.getInstance();
                                                ...
                                                if (stepStatus.ordinal() <= reportSettings.getLogLevel()) {
                                                                String screenshotName = handleStepInvolvingScreenshot(stepName, stepStatus,autoit);
                ...
                */
                ...
                private String handleStepInvolvingScreenshot(String stepName, Status stepStatus) {
                                ...
                                String screenshotName =Util.getCurrentFormattedTime(reportSettings.getDateFormatString()).replace(" ", "_").replace(":", "-")+".png";
                                ...
                                if ((stepStatus.equals(Status.FAIL) && reportSettings.shouldTakeScreenshotFailedStep())
                                                ...
                                                if(testParameters.getExecutionMode().toString().equals("WINIUM")){
                                                                testParameters.setExecutionMode(ExecutionMode
                                                                                                .valueOf("BROWSERSTACK"));
                                                                flag=true;
                                                }else if(testParameters.getExecutionMode().toString().equals("CROSSBROWSER")){
                                                                testParameters.setExecutionMode(ExecutionMode
                                                                                                .valueOf("BROWSERSTACK"));
                                                                flag1=true;
                                                }
                                                ...
                                                if(flag1) {
                                                                testParameters.setExecutionMode(ExecutionMode
                                                                                                .valueOf("CROSSBROWSER"));
                                                }
                                }

                                return screenshotName;
                }
                private String handleStepInvolvingScreenshot(String stepName, Status stepStatus,String autoit) {
                                boolean flag = false,flag1=false;
                                ...
                                if ((stepStatus.equals(Status.FAIL) && reportSettings.shouldTakeScreenshotFailedStep())
                                                ...
                                                takeScreenshot(screenshotPath,autoit);
                                                if(flag) {
                                                                testParameters.setExecutionMode(ExecutionMode
                                                                                                .valueOf("WINIUM"));
                                                }
                ...
                */
                ...
                protected void takeScreenshot(String screenshotPath,String autoit) {
                                Toolkit toolkit = Toolkit.getDefaultToolkit();
                                Dimension screenSize = toolkit.getScreenSize();
                                Rectangle rectangle = new Rectangle(0, 0, screenSize.width, screenSize.height);
                                Robot robot;
                ...
                */
                ...
                private void setTestLogValues(String stepName, String stepDescription, String stepStatus) {
                                ...
                                if (stepStatus.equals(Status.FAIL)) {
                                                testStepBean.setFailureReason(ErrorTypes.Product_Issue.toString());
